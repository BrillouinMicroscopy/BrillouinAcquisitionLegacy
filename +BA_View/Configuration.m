...
%         'FontSize', 11, 'HorizontalAlignment', 'left', 'BackgroundColor', 'red');
    ...
    temperature = uicontrol('Parent', camera, 'Style', 'text', 'String', '', 'Units', 'normalized',...
        'Position', [0.54,0.93,0.24,0.055], 'FontSize', 11, 'HorizontalAlignment', 'left');
...
function onCoolingChange(handles, model)
    ...
    if model.cooling.SensorCooling
        set(handles.temperature, 'String', sprintf('T = %4.1f °C', model.cooling.SensorTemperature));
    else
