...
function handles = initGUI(model, parent)
    ...
    continuousCalibrationTime = uicontrol('Parent', liveCalibration, 'Style', 'edit', 'Units', 'normalized', ...
        ...
        'Position', [0.69,0.255,0.15,0.12], 'FontSize', 11, 'HorizontalAlignment', 'center', 'Tag', 'continuousCalibrationTime');
    
    uicontrol('Parent', liveCalibration, 'Style', 'text', 'Units', 'normalized', 'String', 'min', ...
        'Position', [0.85,0.245,0.13,0.12], 'FontSize', 11, 'HorizontalAlignment', 'left');
    
    % pre calibration
    preCalibration = uicontrol('Parent', liveCalibration, 'Style', 'checkbox', 'Units', 'normalized', ...
        'Position', [0.05,0.43,0.08,0.08], 'FontSize', 11, 'HorizontalAlignment', 'left', 'Tag', 'preCalibration');
    
    uicontrol('Parent', liveCalibration, 'Style', 'text', 'Units', 'normalized', 'String', 'Pre calibration', ...
        'Position', [0.2,0.40,0.78,0.12], 'FontSize', 11, 'HorizontalAlignment', 'left');
    
    % exposure time
    uicontrol('Parent', liveCalibration, 'Style', 'text', 'Units', 'normalized', 'String', 'Exposure time [s]:', ...
        'Position', [0.05,0.565,0.7,0.12], 'FontSize', 11, 'HorizontalAlignment', 'left');
    
    exposureTimeCalibration = uicontrol('Parent', liveCalibration, 'Style', 'edit', 'Units', 'normalized', 'String', model.acquisition.exposureTimeCalibration, ...
        'Position', [0.81,0.58,0.15,0.12], 'FontSize', 11, 'HorizontalAlignment', 'center', 'Tag', 'exposureTimeCalibration');
    
    % number of images
    uicontrol('Parent', liveCalibration, 'Style', 'text', 'Units', 'normalized', 'String', 'Number of images:', ...
        'Position', [0.05,0.715,0.7,0.12], 'FontSize', 11, 'HorizontalAlignment', 'left');
    ...
    nrCalibrationImages = uicontrol('Parent', liveCalibration, 'Style', 'edit', 'Units', 'normalized', 'String', model.acquisition.nrCalibrationImages, ...
        'Position', [0.81,0.73,0.15,0.12], 'FontSize', 11, 'HorizontalAlignment', 'center', 'Tag', 'nrCalibrationImages');
    
    % sample type
    uicontrol('Parent', liveCalibration, 'Style', 'text', 'Units', 'normalized', 'String', 'Sample:', ...
        'Position', [0.05,0.86,0.3,0.12], 'FontSize', 11, 'HorizontalAlignment', 'left');
    
    calibrationSample = uicontrol('Parent', liveCalibration, 'Style','popup', 'Units', 'normalized','Position',[0.4,0.88,0.56,0.12],...
    ...
    handles = struct(...
        ...
        'exposureTimeCalibration', exposureTimeCalibration, ...
